...
export type GitHub_Issue = GitHub_Assignable & GitHub_Closable & GitHub_Comment & GitHub_Labelable & GitHub_Lockable & GitHub_Node & GitHub_Reactable & GitHub_RepositoryNode & GitHub_Subscribable & GitHub_UniformResourceLocatable & GitHub_Updatable & GitHub_UpdatableComment & {
  /** Reason that the conversation was locked. */
  activeLockReason?: Maybe<GitHub_LockReason>;
  /** A list of Users assigned to this object. */
  assignees: GitHub_UserConnection;
...
export type GitHub_Organization = GitHub_Actor & GitHub_MemberStatusable & GitHub_Node & GitHub_PackageOwner & GitHub_ProfileOwner & GitHub_ProjectOwner & GitHub_RepositoryDiscussionAuthor & GitHub_RepositoryDiscussionCommentAuthor & GitHub_RepositoryOwner & GitHub_Sponsorable & GitHub_UniformResourceLocatable & {
...
export type GitHub_PullRequest = GitHub_Assignable & GitHub_Closable & GitHub_Comment & GitHub_Labelable & GitHub_Lockable & GitHub_Node & GitHub_Reactable & GitHub_RepositoryNode & GitHub_Subscribable & GitHub_UniformResourceLocatable & GitHub_Updatable & GitHub_UpdatableComment & {
  /** Reason that the conversation was locked. */
  activeLockReason?: Maybe<GitHub_LockReason>;
...
export type GitHub_User = GitHub_Actor & GitHub_Node & GitHub_PackageOwner & GitHub_ProfileOwner & GitHub_ProjectOwner & GitHub_RepositoryDiscussionAuthor & GitHub_RepositoryDiscussionCommentAuthor & GitHub_RepositoryOwner & GitHub_Sponsorable & GitHub_UniformResourceLocatable & {
  /** Determine if this repository owner has any items that can be pinned to their profile. */
  anyPinnableItems: Scalars['Boolean'];
...
export type UseSiteMetadataQuery = { site?: Maybe<{ siteMetadata?: Maybe<{ siteUrl?: Maybe<string> }> }> };
...
export type DevtoArticleOpenGraphImageQuery = { file?: Maybe<{ childMarkdownRemark?: Maybe<{ frontmatter?: Maybe<{ title?: Maybe<string>, author?: Maybe<string>, author_avatar?: Maybe<string>, date?: Maybe<string> }> }> }> };
...
export type DevtoArticleQuery = { file?: Maybe<{ name: string, childMarkdownRemark?: Maybe<{ frontmatter?: Maybe<{ title?: Maybe<string> }> }> }> };
...
export type GitHubRepositoryOpenGraphImageQuery = { github: { repository?: Maybe<{ name: string, description?: Maybe<string>, stargazerCount: number, forkCount: number, owner: { login: string, avatarUrl: any } | { login: string, avatarUrl: any }, issues: { totalCount: number }, discussions: { totalCount: number }, languages?: Maybe<{ totalSize: number, edges?: Maybe<Array<Maybe<{ size: number, node: { color?: Maybe<string> } }>>> }> }> } };
...
export type GitHubRepositoryTemplateQuery = { github: { repository?: Maybe<{ name: string, owner: { login: string } | { login: string } }> } };

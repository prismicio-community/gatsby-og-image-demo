...
export type Scalars = {
	...
	/**
	 * An ISO-8601 encoded date string. Unlike the DateTime type, GitTimestamp is
	 * not converted in UTC.
	 */
...
export type GitHub = {
	...
	/**
	 * Hack to workaround https://github.com/facebook/relay/issues/112 re-exposing
...
export type GitHub_AddPullRequestReviewThreadInput = {
	...
	pullRequestReviewId?: Maybe<Scalars["ID"]>;
	/**
	 * The side of the diff on which the line resides. For multi-line comments,
	 * this is the side for the end of the line range.
	 */
...
export type GitHub_AssignedEvent = GitHub_Node & {
	 ...
	 *
	 * @deprecated Assignees can now be mannequins. Use the `assignee` field
	 *   instead. Removal on 2020-01-01 UTC.
	 */
	user?: Maybe<GitHub_User>;
};
...
export type GitHub_AuditEntry = {
	...
	user?: Maybe<GitHub_User>;
	/**
	 * For actions involving two users, the actor is the initiator and the user is
	 * the affected user.
	 */
...
export type GitHub_BlameRange = {
	 ...
	 * calculated as a 2-quantile and determines the length of distance between
	 * the median age of all the changes in the file and the recency of the
	 * current range's change.
	 */
	age: Scalars["Int"];
	/**
 ...
 */
export type GitHub_Blob = GitHub_GitObject &
	GitHub_Node & {
		/**
		...
		id: Scalars["ID"];
		/**
		 * Indicates whether the Blob is binary or text. Returns null if unable to
 ...
 */
export type GitHub_Bot = GitHub_Actor &
	GitHub_Node &
...
export type GitHub_BranchProtectionRule = GitHub_Node & {
	...
	/**
	 * A list of conflicts matching branches protection rule and other branch
	 * protection rules
	 */
...
export type GitHub_CancelSponsorshipInput = {
	...
	/**
	 * The username of the user or organization who is acting as the sponsor,
	 * paying for the sponsorship. Required if sponsorId is not given.
	 */
	sponsorLogin?: Maybe<Scalars["String"]>;
	/**
	 * The ID of the user or organization who is receiving the sponsorship.
	 * Required if sponsorableLogin is not given.
	 */
	sponsorableId?: Maybe<Scalars["ID"]>;
	/**
	 * The username of the user or organization who is receiving the sponsorship.
	 * Required if sponsorableId is not given.
	 */
...
export type GitHub_ChangeUserStatusInput = {
	 ...
	 * an emoji name with colons, e.g., :grinning:.
	 */
	...
	message?: Maybe<Scalars["String"]>;
	/**
	 * The ID of the organization whose members will be allowed to see the status.
	 * If omitted, the status will be publicly visible.
	 */
	organizationId?: Maybe<Scalars["ID"]>;
};
...
export enum GitHub_CheckConclusionState {
	...
	Skipped = "SKIPPED",
	/**
	 * The check suite or run was marked stale by GitHub. Only GitHub can use this
	 * conclusion.
	 */
	Stale = "STALE",
	/**
...
export type GitHub_CheckSuiteAutoTriggerPreference = {
	...
	appId: Scalars["ID"];
	/**
	 * Set to `true` to enable automatic creation of CheckSuite events upon pushes
	 * to the repository.
	 */
...
export enum GitHub_CommentCannotUpdateReason {
	...
	Denied = "DENIED",
	/**
	 * You must be the author or have write access to this repository to update
	 * this comment.
	 */
 ...
 */
export type GitHub_Commit = GitHub_GitObject &
	GitHub_Node &
	GitHub_Subscribable &
	GitHub_UniformResourceLocatable & {
		/**
		...
		/**
		 * The merged Pull Request that introduced the commit to the repository. If
		 * the commit is not present in the default branch, additionally returns open
		...
		/**
		 * The list of authors for this commit based on the git author and the
		 * Co-authored-by message trailer. The git author will always be first.
		 */
		...
		/**
		 * The linear commit history starting from (and including) this commit, in the
		...
		/**
		 * Returns a list of all submodules in this repository as of this Commit
		 * parsed from the .gitmodules file.
		 */
		submodules: GitHub_SubmoduleConnection;
		/**
		 * Returns a URL to download a tarball archive for a repository. Note: For
		 * private repositories, these links are temporary and expire after five minutes.
		 */
		...
		/**
		 * Identifies if the viewer is watching, not watching, or ignoring the
		 * subscribable entity.
		 */
		viewerSubscription?: Maybe<GitHub_SubscriptionState>;
		/**
		 * Returns a URL to download a zipball archive for a repository. Note: For
		 * private repositories, these links are temporary and expire after five minutes.
		 */
...
export type GitHub_CommitAuthor = {
	/**
	 * Email addresses to filter by. Commits authored by any of the specified
	 * email addresses will be returned.
	 */
 ...
 */
export type GitHub_CommitComment = GitHub_Comment &
	GitHub_Deletable &
	GitHub_Minimizable &
	GitHub_Node &
	GitHub_Reactable &
 ...
 * `refs/heads/` (although the input is not required to be fully qualified).
 *
 * The Ref may be specified by its global node ID or by the repository
 * nameWithOwner and branch name.
 *
 * ### Examples
 *
...
export type GitHub_Contribution = {
	/**
	 * Whether this contribution is associated with a record you do not have
	 * access to. For example, your own 'first issue' contribution may have been
	 * made on a repository you can no longer access.
	 */
...
export type GitHub_ContributionCalendar = {
	/**
	 * A list of hex color codes used in this calendar. The darker the color, the
	 * more contributions it represents.
	 */
...
export type GitHub_ContributionCalendarDay = {
	...
	/**
	 * Indication of contributions, relative to other days. Can be used to
	 * indicate which color to represent this day on a calendar.
	 */
	...
	/**
	 * A number representing which day of the week this square represents, e.g., 1
	 * is Monday.
	 */
	weekday: Scalars["Int"];
};
...
export enum GitHub_ContributionLevel {
	...
	None = "NONE",
	/**
	 * Second lowest 25% of days of contributions. More contributions than the
	 * first quartile.
	 */
	SecondQuartile = "SECOND_QUARTILE",
	/**
	 * Second highest 25% of days of contributions. More contributions than second
	 * quartile, less than the fourth quartile.
	 */
...
/**
 * A contributions collection aggregates contributions such as opened issues and
 * commits created by a user.
 */
export type GitHub_ContributionsCollection = {
	...
	/**
	 * The first issue the user opened on GitHub. This will be null if that issue
	 * was opened outside the collection's time range and ignoreTimeRange is
	 * false. If the issue is not visible but the user has opted to show private
	 * contributions, a RestrictedContribution will be returned.
	 */
	firstIssueContribution?: Maybe<GitHub_CreatedIssueOrRestrictedContribution>;
	/**
	 * The first pull request the user opened on GitHub. This will be null if that
	 * pull request was opened outside the collection's time range and
	 * ignoreTimeRange is not true. If the pull request is not visible but the
	 * user has opted to show private contributions, a RestrictedContribution will
	 * be returned.
	 */
	...
	/**
	 * Does the user have any more activity in the timeline that occurred prior to
	 * the collection's time range?
	 */
	...
	/**
	 * Determine if the user made any contributions in this time frame whose
	 * details are not visible because they were made in a private repository. Can
	 * only be true if the user enabled private contribution counts.
	 */
	...
	/**
	 * The date of the most recent restricted contribution the user made in this
	 * time period. Can only be non-null when the user has enabled private
	 * contribution counts.
	 */
	latestRestrictedContributionDate?: Maybe<Scalars["GitHub_Date"]>;
	/**
	 * When this collection's time range does not include any activity from the
	 * user, use this to get a different collection from an earlier time range
	 * that does have activity.
	 */
	mostRecentCollectionWithActivity?: Maybe<GitHub_ContributionsCollection>;
	/**
	 * Returns a different contributions collection from an earlier time range
	 * than this one that does not have any contributions.
	 */
	mostRecentCollectionWithoutActivity?: Maybe<GitHub_ContributionsCollection>;
	/**
	 * The issue the user opened on GitHub that received the most comments in the
	 * specified time frame.
	 */
	popularIssueContribution?: Maybe<GitHub_CreatedIssueContribution>;
	/**
	 * The pull request the user opened on GitHub that received the most comments
	 ...
	 * Only non-zero when the user has chosen to share their private contribution counts.
	 */
...
export type GitHub_CreateBranchProtectionRuleInput = {
	...
	/**
	 * The global relay id of the repository in which a new branch protection rule
	...
	/**
	 * A list of User or Team IDs allowed to dismiss reviews on pull requests
...
export type GitHub_CreateIssueInput = {
	...
	clientMutationId?: Maybe<Scalars["String"]>;
	/**
	 * The name of an issue template in the repository, assigns labels and
	 * assignees from the template to the issue
	 */
...
export type GitHub_CreateSponsorshipInput = {
	/**
	 * The amount to pay to the sponsorable in US dollars. Required if a tierId is
	 * not specified. Valid values: 1-12000.
	 */
	...
	clientMutationId?: Maybe<Scalars["String"]>;
	/**
	 * Whether the sponsorship should happen monthly/yearly or just this one time.
	 * Required if a tierId is not specified.
	 */
	...
	sponsorableLogin?: Maybe<Scalars["String"]>;
	/**
	 * The ID of one of sponsorable's existing tiers to sponsor at. Required if
...
export type GitHub_CreateTeamDiscussionInput = {
	 ...
	 * organization admins. If false or not specified, allows any organization
	 * member to view this discussion.
	 */
...
export type GitHub_DiscussionCategory = GitHub_Node &
	GitHub_RepositoryNode & {
		...
		id: Scalars["ID"];
		/**
		 * Whether or not discussions in this category support choosing an answer with
		 * the markDiscussionCommentAsAnswer mutation.
		 */
 ...
 */
export type GitHub_DiscussionComment = GitHub_Comment &
	GitHub_Deletable &
	GitHub_Minimizable &
	GitHub_Node &
	GitHub_Reactable &
...
export type GitHub_EnterpriseBillingInfo = {
	...
	/**
	 * The number of available seats across all owned organizations based on the
	 * unique number of billable users.
	 *
	 * @deprecated `availableSeats` will be replaced with `totalAvailableLicenses`
	 *   to provide more clarity on the value being returned Use
	 *   EnterpriseBillingInfo.totalAvailableLicenses instead. Removal on 2020-01-01 UTC.
	 */
	 ...
	 *
	 * @deprecated `seats` will be replaced with `totalLicenses` to provide more
	 *   clarity on the value being returned Use
	 *   EnterpriseBillingInfo.totalLicenses instead. Removal on 2020-01-01 UTC.
	 */
	seats: Scalars["Int"];
	/**
	...
	/**
	 * The number of available licenses across all owned organizations based on
	 * the unique number of billable users.
	 */
...
export enum GitHub_EnterpriseDefaultRepositoryPermissionSettingValue {
	/**
	 * Organization members will be able to clone, pull, push, and add new
	 * collaborators to all organization repositories.
	 */
	Admin = "ADMIN",
	/**
	...
	Read = "READ",
	/**
	 * Organization members will be able to clone, pull, and push all organization
	 * repositories.
	 */
	Write = "WRITE",
}
...
export type GitHub_EnterpriseIdentityProvider = GitHub_Node & {
	...
	/**
	 * Recovery codes that can be used by admins to access the enterprise if the
 ...
 */
export type GitHub_EnterpriseMember =
	| GitHub_EnterpriseUserAccount
	| GitHub_User;
...
/**
 * A User who is an outside collaborator of an enterprise through one or more
 * organizations.
 */
...
export type GitHub_EnterpriseOwnerInfo = {
	...
	/**
	 * Whether or not affiliated users with two-factor authentication disabled
	 * exist in the enterprise.
	 */
	affiliatedUsersWithTwoFactorDisabledExist: Scalars["Boolean"];
	/**
	 * The setting value for whether private repository forking is enabled for
	 * repositories in organizations in this enterprise.
	 */
	allowPrivateRepositoryForkingSetting: GitHub_EnterpriseEnabledDisabledSettingValue;
	/**
	 * A list of enterprise organizations configured with the provided private
	 * repository forking setting value.
	 */
	allowPrivateRepositoryForkingSettingOrganizations: GitHub_OrganizationConnection;
	/**
	 * The setting value for base repository permissions for organizations in this
	 * enterprise.
	 */
	defaultRepositoryPermissionSetting: GitHub_EnterpriseDefaultRepositoryPermissionSettingValue;
	/**
	 * A list of enterprise organizations configured with the provided base
	...
	/**
	 * The setting value for whether organization members with admin permissions
	 * on a repository can change repository visibility.
	 */
	membersCanChangeRepositoryVisibilitySetting: GitHub_EnterpriseEnabledDisabledSettingValue;
	/**
	 * A list of enterprise organizations configured with the provided can change
	 * repository visibility setting value.
	 */
	membersCanChangeRepositoryVisibilitySettingOrganizations: GitHub_OrganizationConnection;
	/**
	 * The setting value for whether members of organizations in the enterprise
	 * can create internal repositories.
	 */
	...
	/**
	 * A list of enterprise organizations configured with the provided repository
	 * creation setting value.
	 */
	...
	/**
	 * A list of enterprise organizations configured with the provided members can
	 * delete issues setting value.
	 */
	...
	/**
	 * A list of enterprise organizations configured with the provided members can
	 * update protected branches setting value.
	 */
	...
	/**
	 * A list of enterprise organizations configured with the provided members can
	 * view dependency insights setting value.
	 */
	 ...
	 * to verified or approved domains.
	 */
	notificationDeliveryRestrictionEnabledSetting: GitHub_NotificationRestrictionSettingValue;
	/**
	 * The setting value for whether organization projects are enabled for
	 ...
	 *
	 * @deprecated Repository invitations can now be associated with an email, not
	 *   only an invitee. Use the `pendingCollaboratorInvitations` field instead.
	 *   Removal on 2020-10-01 UTC.
	 */
	...
	/**
	 * A list of enterprise organizations configured with the SAML single sign-on
	 * setting value.
	 */
	...
	/**
	 * A list of enterprise organizations configured with the provided team
	 * discussions setting value.
	 */
...
/**
 * A user with an invitation to be a collaborator on a repository owned by an
...
export type GitHub_EnterpriseServerInstallation = GitHub_Node & {
	...
	id: Scalars["ID"];
	/**
	 * Whether or not the installation is connected to an Enterprise Server
	 * installation via GitHub Connect.
	 */
...
export type GitHub_EnterpriseServerUserAccount = GitHub_Node & {
	...
	id: Scalars["ID"];
	/**
	 * Whether the user account is a site administrator on the Enterprise Server
	 * installation.
	 */
	...
	/**
	 * The date and time when the user account was created on the Enterprise
	 * Server installation.
	 */
...
/**
 * An account for a user who is an admin of an enterprise or a member of an
 * enterprise through one or more organizations.
 */
...
export type GitHub_ExternalIdentity = GitHub_Node & {
	...
	/**
	 * User linked to this external identity. Will be NULL if this identity has
	 * not been claimed by an organization member.
	 */
	user?: Maybe<GitHub_User>;
};
...
/**
 * A command to add a file at the given path with the given contents as part of
 * a commit. Any existing file at that that path will be replaced.
 */
...
/**
 * A description of a set of changes to a file tree to be made as part of a git
 * commit, modeled as zero or more file `additions` and zero or more file `deletions`.
 *
 * Both fields are optional; omitting both will produce a commit with no file changes.
 *
 * `deletions` and `additions` describe changes to files identified by their
 * path in the git tree using unix-style path separators, i.e. `/`. The root of
 * a git tree is an empty string, so paths are not slash-prefixed.
 *
 * `path` values must be unique across all `additions` and `deletions` provided.
 * Any duplication will result in a validation error.
 *
 * ### Encoding
 *
 * File contents must be provided in full for each `FileAddition`.
 *
 * The `contents` of a `FileAddition` must be encoded using RFC 4648 compliant
 * base64, i.e. correct padding is required and no characters outside the
 * standard alphabet may be used. Invalid base64 encoding will be rejected with
 * a validation error.
 *
 * The encoded contents may be binary.
 *
 * For text files, no assumptions are made about the character encoding of the
 * file contents (after base64 decoding). No charset transcoding or line-ending
 * normalization will be performed; it is the client's responsibility to manage
 * the character encoding of files they provide. However, for maximum
 * compatibility we recommend using UTF-8 encoding and ensuring that all files
 * in a repository use a consistent line-ending convention (`\n` or `\r\n`), and
 * that all files end with a newline.
 *
 * ### Modeling file changes
 *
 * Each of the the five types of conceptual changes that can be made in a git
 ...
 *          ]
 *        }
 * 3. Existing file deletion: remove existing file `docs/README.txt`. Note that the
 *    path is required to exist -- specifying a path that does not exist on the
 *    given branch will abort the commit and return an error.
 *
 *        {
 *          "deletions" [
 *            {
 ...
 *          ]
 *        }
 * 4. File rename with no changes: rename `docs/README.txt` with previous content
 ...
 *          ]
 *        }
 * 5. File rename with changes: rename `docs/README.txt` with previous content
 *    `hello world\n` to a file at path `newdocs/README.txt` with content `new
 *    contents\n`:
 *
 *        {
 *          "deletions" [
 ...
 */
export type GitHub_GistComment = GitHub_Comment &
	GitHub_Deletable &
	GitHub_Minimizable &
	GitHub_Node &
	GitHub_Updatable &
...
/**
 * The possible states in which authentication can be configured with an
 * identity provider.
 */
...
/**
 * The possible values for the IP allow list configuration for installed GitHub
 * Apps setting.
 */
 ...
 */
export type GitHub_IpAllowListOwner =
	| GitHub_App
	| GitHub_Enterprise
	| GitHub_Organization;
 ...
 */
export type GitHub_Issue = GitHub_Assignable &
	GitHub_Closable &
	GitHub_Comment &
	GitHub_Labelable &
	GitHub_Lockable &
	...
	GitHub_UpdatableComment & {
		 ...
		 *
		 * @deprecated `timeline` will be removed Use Issue.timelineItems instead.
		 *   Removal on 2020-10-01 UTC.
		 */
 ...
 */
export type GitHub_IssueComment = GitHub_Comment &
	GitHub_Deletable &
	GitHub_Minimizable &
	GitHub_Node &
	GitHub_Reactable &
	...
	GitHub_UpdatableComment & {
		...
		publishedAt?: Maybe<Scalars["GitHub_DateTime"]>;
		/**
		 * Returns the pull request associated with the comment, if this comment was
...
export type GitHub_IssueFilters = {
	/**
	 * List issues assigned to given name. Pass in `null` for issues with no
	 ...
	 * integer is passed, it should refer to a milestone by its number field. Pass
	 * in `null` for issues with no milestone, and `*` for issues that are
...
/**
 * A label for categorizing Issues, Pull Requests, Milestones, or Discussions
...
export type GitHub_License = GitHub_Node & {
	...
	/**
	 * URL to the license on [https://choosealicense.com](https://choosealicense.com)
	 */
	url?: Maybe<Scalars["GitHub_URI"]>;
};
 ...
 */
export type GitHub_Mannequin = GitHub_Actor &
	GitHub_Node &
	GitHub_UniformResourceLocatable & {
		/**
		 * A URL pointing to the GitHub App's public avatar.
...
export type GitHub_MarketplaceListing = GitHub_Node & {
	...
	/**
	 * Whether this draft listing has been submitted for review for approval to be
	 * unverified in the Marketplace.
	 */
	isUnverifiedPending: Scalars["Boolean"];
	/**
	 * Whether this draft listing has been submitted for review from GitHub for
	 * approval to be verified in the Marketplace.
	 */
	isVerificationPendingFromDraft: Scalars["Boolean"];
	/**
	 * Whether this unverified listing has been submitted for review from GitHub
	 * for approval to be verified in the Marketplace.
	 */
	...
	/**
	 * URL to the listing's privacy policy, may return an empty string for
	 * listings that do not require a privacy policy URL.
	 */
	...
	/**
	 * Can the current viewer return this Marketplace listing to draft state so it
	...
	/**
	 * Can the current viewer request this listing be reviewed for display in the
	 * Marketplace as verified.
	 */
	viewerCanRequestApproval: Scalars["Boolean"];
	/**
	 * Indicates whether the current user has an active subscription to this
	 * Marketplace listing.
	 */
...
export type GitHub_MemberStatusable = {
	 ...
	 * public or visible only to the organization.
	 */
 ...
 */
export type GitHub_MembersCanDeleteReposClearAuditEntry = GitHub_AuditEntry &
 ...
 */
export type GitHub_MembersCanDeleteReposDisableAuditEntry = GitHub_AuditEntry &
	GitHub_EnterpriseAuditEntryData &
	GitHub_Node &
	GitHub_OrganizationAuditEntryData & {
		/**
 ...
 */
export type GitHub_MembersCanDeleteReposEnableAuditEntry = GitHub_AuditEntry &
	GitHub_EnterpriseAuditEntryData &
	GitHub_Node &
	GitHub_OrganizationAuditEntryData & {
		/**
...
export type GitHub_MergeBranchInput = {
	...
	/**
	 * The head to merge into the base branch. This can be a branch name or a
	 * commit GitObjectID.
	 */
	head: Scalars["String"];
	/**
...
export type GitHub_MergePullRequestInput = {
	...
	commitBody?: Maybe<Scalars["String"]>;
	/**
	 * Commit headline to use for the merge commit; if omitted, a default message
	 * will be used.
	 */
	commitHeadline?: Maybe<Scalars["String"]>;
	/**
 ...
 */
export type GitHub_Milestone = GitHub_Closable &
	GitHub_Node &
	GitHub_UniformResourceLocatable & {
		/**
		 * `true` if the object is closed (definition of closed may depend on type)
...
export type GitHub_MoveProjectColumnInput = {
	/**
	 * Place the new column after the column with this id. Pass null to place it
	 * at the front.
	 */
 ...
 */
export type GitHub_OauthApplicationCreateAuditEntry = GitHub_AuditEntry &
	GitHub_Node &
...
export enum GitHub_OauthApplicationCreateAuditEntryState {
	...
	/**
	 * The OAuth Application was suspended from generating OAuth Accesses due to
 ...
 */
export type GitHub_OrgAddBillingManagerAuditEntry = GitHub_AuditEntry &
	GitHub_Node &
	GitHub_OrganizationAuditEntryData & {
		/**
		 * The action name
 ...
 */
export type GitHub_OrgAddMemberAuditEntry = GitHub_AuditEntry &
	GitHub_Node &
	GitHub_OrganizationAuditEntryData & {
		/**
		 * The action name
 ...
 */
export type GitHub_OrgBlockUserAuditEntry = GitHub_AuditEntry &
	GitHub_Node &
	GitHub_OrganizationAuditEntryData & {
		/**
		 * The action name
 ...
 */
export type GitHub_OrgConfigDisableCollaboratorsOnlyAuditEntry =
	GitHub_AuditEntry &
		GitHub_Node &
		GitHub_OrganizationAuditEntryData & {
			/**
 ...
 */
export type GitHub_OrgConfigEnableCollaboratorsOnlyAuditEntry =
	GitHub_AuditEntry &
		GitHub_Node &
		GitHub_OrganizationAuditEntryData & {
			/**
 ...
 */
export type GitHub_OrgCreateAuditEntry = GitHub_AuditEntry &
	GitHub_Node &
	GitHub_OrganizationAuditEntryData & {
		/**
		 * The action name
 ...
 */
export type GitHub_OrgDisableOauthAppRestrictionsAuditEntry =
	GitHub_AuditEntry &
		GitHub_Node &
		GitHub_OrganizationAuditEntryData & {
			/**
 ...
 */
export type GitHub_OrgDisableSamlAuditEntry = GitHub_AuditEntry &
	GitHub_Node &
	GitHub_OrganizationAuditEntryData & {
		/**
		 * The action name
 ...
 */
export type GitHub_OrgDisableTwoFactorRequirementAuditEntry =
	GitHub_AuditEntry &
		GitHub_Node &
		GitHub_OrganizationAuditEntryData & {
			/**
 ...
 */
export type GitHub_OrgEnableOauthAppRestrictionsAuditEntry = GitHub_AuditEntry &
	GitHub_Node &
	GitHub_OrganizationAuditEntryData & {
		/**
		 * The action name
 ...
 */
export type GitHub_OrgEnableSamlAuditEntry = GitHub_AuditEntry &
	GitHub_Node &
	GitHub_OrganizationAuditEntryData & {
		/**
		 * The action name
 ...
 */
export type GitHub_OrgEnableTwoFactorRequirementAuditEntry = GitHub_AuditEntry &
	GitHub_Node &
	GitHub_OrganizationAuditEntryData & {
		/**
		 * The action name
 ...
 */
export type GitHub_OrgInviteMemberAuditEntry = GitHub_AuditEntry &
	GitHub_Node &
	GitHub_OrganizationAuditEntryData & {
		/**
		 * The action name
 ...
 */
export type GitHub_OrgInviteToBusinessAuditEntry = GitHub_AuditEntry &
	GitHub_EnterpriseAuditEntryData &
	GitHub_Node &
	GitHub_OrganizationAuditEntryData & {
		/**
 ...
 */
export type GitHub_OrgOauthAppAccessApprovedAuditEntry = GitHub_AuditEntry &
	GitHub_Node &
	GitHub_OauthApplicationAuditEntryData &
	GitHub_OrganizationAuditEntryData & {
		/**
 ...
 */
export type GitHub_OrgOauthAppAccessDeniedAuditEntry = GitHub_AuditEntry &
	GitHub_Node &
	GitHub_OauthApplicationAuditEntryData &
	GitHub_OrganizationAuditEntryData & {
		/**
 ...
 */
export type GitHub_OrgOauthAppAccessRequestedAuditEntry = GitHub_AuditEntry &
	GitHub_Node &
	GitHub_OauthApplicationAuditEntryData &
	GitHub_OrganizationAuditEntryData & {
		/**
 ...
 */
export type GitHub_OrgRemoveBillingManagerAuditEntry = GitHub_AuditEntry &
	GitHub_Node &
	GitHub_OrganizationAuditEntryData & {
		/**
		 * The action name
...
export enum GitHub_OrgRemoveBillingManagerAuditEntryReason {
	...
	/**
	 * The organization required 2FA of its billing managers and this user did not
	 * have 2FA enabled.
	 */
 ...
 */
export type GitHub_OrgRemoveMemberAuditEntry = GitHub_AuditEntry &
	GitHub_Node &
	GitHub_OrganizationAuditEntryData & {
		/**
		 * The action name
...
export enum GitHub_OrgRemoveMemberAuditEntryMembershipType {
	/**
	 * Organization administrators have full access and can change several
	 * settings, including the names of repositories that belong to the
	 * Organization and Owners team membership. In addition, organization admins
	 * can delete the organization and all of its repositories.
	 */
	Admin = "ADMIN",
	/**
	 * A billing manager is a user who manages the billing settings for the
	 * Organization, such as updating payment information.
	 */
	BillingManager = "BILLING_MANAGER",
	/**
 ...
 */
export type GitHub_OrgRemoveOutsideCollaboratorAuditEntry = GitHub_AuditEntry &
	GitHub_Node &
	GitHub_OrganizationAuditEntryData & {
		/**
		 * The action name
 ...
 */
export type GitHub_OrgRestoreMemberAuditEntry = GitHub_AuditEntry &
	GitHub_Node &
	GitHub_OrganizationAuditEntryData & {
		/**
		 * The action name
 ...
 */
export type GitHub_OrgUnblockUserAuditEntry = GitHub_AuditEntry &
	GitHub_Node &
	GitHub_OrganizationAuditEntryData & {
		/**
		 * The action name
 ...
 */
export type GitHub_OrgUpdateMemberAuditEntry = GitHub_AuditEntry &
	GitHub_Node &
	GitHub_OrganizationAuditEntryData & {
		/**
		 * The action name
...
export enum GitHub_OrgUpdateMemberRepositoryCreationPermissionAuditEntryVisibility {
	...
	Private = "PRIVATE",
	/**
	 * All organization members are restricted from creating private or internal
	 * repositories.
	 */
	...
	Public = "PUBLIC",
	/**
	 * All organization members are restricted from creating public or internal
	 * repositories.
	 */
...
/**
 * An account on GitHub, with one or more owners, that has repositories, members
 * and teams.
 */
export type GitHub_Organization = GitHub_Actor &
	...
	GitHub_UniformResourceLocatable & {
		...
		/**
		 * The estimated monthly GitHub Sponsors income for this user/organization in
		 * cents (USD).
		 */
		...
		/**
		 * When true the organization requires all members, billing managers, and
		 * outside collaborators to enable two-factor authentication.
		 */
...
export type GitHub_OrganizationMemberEdge = {
	...
	cursor: Scalars["String"];
	/**
	 * Whether the organization member has two factor enabled or not. Returns null
	 * if information is not available to viewer.
	 */
...
/**
 * Represents a object that contains package version activity statistics such as
 * downloads.
 */
...
/**
 * Preconfigured gradients that may be used to style discussions pinned within a
 * repository.
 */
...
/**
 * Preconfigured background patterns that may be used to style discussions
 ...
 */
export type GitHub_PrivateRepositoryForkingDisableAuditEntry =
	GitHub_AuditEntry &
		GitHub_EnterpriseAuditEntryData &
		GitHub_Node &
		GitHub_OrganizationAuditEntryData &
 ...
 */
export type GitHub_PrivateRepositoryForkingEnableAuditEntry =
	GitHub_AuditEntry &
		GitHub_EnterpriseAuditEntryData &
		GitHub_Node &
		GitHub_OrganizationAuditEntryData &
...
/**
 * A curatable list of repositories relating to a repository owner, which
 * defaults to showing the most popular repositories they own.
 */
export type GitHub_ProfileItemShowcase = {
	 ...
	 * pinned items, those will be returned. Otherwise, the profile owner's
	 * popular repositories will be returned.
	 */
 ...
 */
export type GitHub_Project = GitHub_Closable &
	GitHub_Node &
	GitHub_Updatable & {
		/**
...
export type GitHub_ProjectCard = GitHub_Node & {
	/**
	 * The project column this card is associated under. A card may only belong to
	 * one project column at a time. The column field will be null if the card is
	 * created in a pending state and has yet to be associated with a column. Once
	 * cards are associated with a column, they will not become pending in the future.
	 */
	column?: Maybe<GitHub_ProjectColumn>;
	/**
...
export enum GitHub_ProjectTemplate {
	/**
	 * Create a board with v2 triggers to automatically move cards across To do,
	 * In progress and Done columns.
	 */
	AutomatedKanbanV2 = "AUTOMATED_KANBAN_V2",
	/**
	 * Create a board with triggers to automatically move cards across columns
...
export type GitHub_PublicKey = GitHub_Node & {
	/**
	 * The last time this authorization was used to perform an action. Values will
	 * be null for keys not owned by the user.
	 */
	accessedAt?: Maybe<Scalars["GitHub_DateTime"]>;
	/**
	 * Identifies the date and time when the key was created. Keys created before
	 * March 5th, 2014 have inaccurate values. Values will be null for keys not
	 * owned by the user.
	 */
	createdAt?: Maybe<Scalars["GitHub_DateTime"]>;
	/**
	...
	id: Scalars["ID"];
	/**
	 * Whether this PublicKey is read-only or not. Values will be null for keys
	 ...
	 * March 5th, 2014 may have inaccurate values. Values will be null for keys
	 * not owned by the user.
	 */
	updatedAt?: Maybe<Scalars["GitHub_DateTime"]>;
};
 ...
 */
export type GitHub_PullRequest = GitHub_Assignable &
	GitHub_Closable &
	GitHub_Comment &
	GitHub_Labelable &
	GitHub_Lockable &
	...
	GitHub_UpdatableComment & {
		...
		/**
		 * Identifies the name of the base Ref associated with the pull request, even
		 * if the ref has been deleted.
		 */
		baseRefName: Scalars["String"];
		/**
		 * Identifies the oid of the base ref associated with the pull request, even
		 * if the ref has been deleted.
		 */
		...
		comments: GitHub_IssueCommentConnection;
		/**
		 * A list of commits present in this pull request's head branch not present in
		 * the base branch.
		 */
		...
		headRef?: Maybe<GitHub_Ref>;
		/**
		 * Identifies the name of the head Ref associated with the pull request, even
		 * if the ref has been deleted.
		 */
		headRefName: Scalars["String"];
		/**
		 * Identifies the oid of the head ref associated with the pull request, even
		 * if the ref has been deleted.
		 */
		...
		/**
		 * A list of latest reviews per user associated with the pull request that are
		 * not also pending review.
		 */
		 ...
		 *
		 * @deprecated `timeline` will be removed Use PullRequest.timelineItems
 ...
 */
export type GitHub_PullRequestReview = GitHub_Comment &
	GitHub_Deletable &
	GitHub_Node &
	GitHub_Reactable &
	GitHub_RepositoryNode &
 ...
 */
export type GitHub_PullRequestReviewComment = GitHub_Comment &
	GitHub_Deletable &
	GitHub_Minimizable &
	GitHub_Node &
	GitHub_Reactable &
...
/**
 * Represents the latest point in the pull request timeline for which the viewer
 * has seen the pull request's commits.
 */
...
export enum GitHub_PullRequestTimelineItemsItemType {
	...
	/**
	 * Represents the latest point in the pull request timeline for which the
	 * viewer has seen the pull request's commits.
	 */
...
export type GitHub_RateLimit = {
	...
	cost: Scalars["Int"];
	/**
	 * The maximum number of points the client is permitted to consume in a 60
	 * minute window.
	 */
	limit: Scalars["Int"];
	/**
...
export type GitHub_ReactionGroup = {
	...
	/**
	 * Users who have reacted to the reaction subject with the emotion represented
	 * by this reaction group
	 *
	 * @deprecated Reactors can now be mannequins, bots, and organizations. Use
	 *   the `reactors` field instead. Removal on 2021-10-01 UTC.
	 */
...
export type GitHub_ReferencedEvent = GitHub_Node & {
	...
	isCrossRepository: Scalars["Boolean"];
	/**
	 * Checks if the commit message itself references the subject. Can be false in
	 * the case of a commit comment reference.
	 */
 ...
 */
export type GitHub_RepoAccessAuditEntry = GitHub_AuditEntry &
	GitHub_Node &
	GitHub_OrganizationAuditEntryData &
	GitHub_RepositoryAuditEntryData & {
		/**
 ...
 */
export type GitHub_RepoAddMemberAuditEntry = GitHub_AuditEntry &
	GitHub_Node &
	GitHub_OrganizationAuditEntryData &
	GitHub_RepositoryAuditEntryData & {
		/**
 ...
 */
export type GitHub_RepoAddTopicAuditEntry = GitHub_AuditEntry &
	GitHub_Node &
	GitHub_OrganizationAuditEntryData &
	GitHub_RepositoryAuditEntryData &
 ...
 */
export type GitHub_RepoArchivedAuditEntry = GitHub_AuditEntry &
	GitHub_Node &
	GitHub_OrganizationAuditEntryData &
	GitHub_RepositoryAuditEntryData & {
		/**
 ...
 */
export type GitHub_RepoChangeMergeSettingAuditEntry = GitHub_AuditEntry &
	GitHub_Node &
	GitHub_OrganizationAuditEntryData &
	GitHub_RepositoryAuditEntryData & {
		/**
...
export enum GitHub_RepoChangeMergeSettingAuditEntryMergeType {
	...
	Merge = "MERGE",
	/**
	 * Commits from the pull request are added onto the base branch individually
	 * without a merge commit.
	 */
	Rebase = "REBASE",
	/**
	 * The pull request's commits are squashed into a single commit before they
	 * are merged to the base branch.
	 */
	Squash = "SQUASH",
}
 ...
 */
export type GitHub_RepoConfigDisableAnonymousGitAccessAuditEntry =
	GitHub_AuditEntry &
		GitHub_Node &
		GitHub_OrganizationAuditEntryData &
		GitHub_RepositoryAuditEntryData & {
 ...
 */
export type GitHub_RepoConfigDisableCollaboratorsOnlyAuditEntry =
	GitHub_AuditEntry &
		GitHub_Node &
		GitHub_OrganizationAuditEntryData &
		GitHub_RepositoryAuditEntryData & {
 ...
 */
export type GitHub_RepoConfigDisableContributorsOnlyAuditEntry =
	GitHub_AuditEntry &
		GitHub_Node &
		GitHub_OrganizationAuditEntryData &
		GitHub_RepositoryAuditEntryData & {
 ...
 */
export type GitHub_RepoConfigEnableAnonymousGitAccessAuditEntry =
	GitHub_AuditEntry &
		GitHub_Node &
		GitHub_OrganizationAuditEntryData &
		GitHub_RepositoryAuditEntryData & {
 ...
 */
export type GitHub_RepoConfigEnableCollaboratorsOnlyAuditEntry =
	GitHub_AuditEntry &
		GitHub_Node &
		GitHub_OrganizationAuditEntryData &
		GitHub_RepositoryAuditEntryData & {
 ...
 */
export type GitHub_RepoConfigEnableContributorsOnlyAuditEntry =
	GitHub_AuditEntry &
		GitHub_Node &
		GitHub_OrganizationAuditEntryData &
		GitHub_RepositoryAuditEntryData & {
 ...
 */
export type GitHub_RepoConfigLockAnonymousGitAccessAuditEntry =
	GitHub_AuditEntry &
		GitHub_Node &
		GitHub_OrganizationAuditEntryData &
		GitHub_RepositoryAuditEntryData & {
 ...
 */
export type GitHub_RepoConfigUnlockAnonymousGitAccessAuditEntry =
	GitHub_AuditEntry &
		GitHub_Node &
		GitHub_OrganizationAuditEntryData &
		GitHub_RepositoryAuditEntryData & {
 ...
 */
export type GitHub_RepoCreateAuditEntry = GitHub_AuditEntry &
	GitHub_Node &
	GitHub_OrganizationAuditEntryData &
	GitHub_RepositoryAuditEntryData & {
		/**
 ...
 */
export type GitHub_RepoDestroyAuditEntry = GitHub_AuditEntry &
	GitHub_Node &
	GitHub_OrganizationAuditEntryData &
	GitHub_RepositoryAuditEntryData & {
		/**
 ...
 */
export type GitHub_RepoRemoveMemberAuditEntry = GitHub_AuditEntry &
	GitHub_Node &
	GitHub_OrganizationAuditEntryData &
	GitHub_RepositoryAuditEntryData & {
		/**
 ...
 */
export type GitHub_RepoRemoveTopicAuditEntry = GitHub_AuditEntry &
	GitHub_Node &
	GitHub_OrganizationAuditEntryData &
	GitHub_RepositoryAuditEntryData &
	GitHub_TopicAuditEntryData & {
...
export type GitHub_Repository = GitHub_Node &
	...
	GitHub_UniformResourceLocatable & {
		...
		isFork: Scalars["Boolean"];
		/**
		 * Indicates if a repository is either owned by an organization, or is a
		 * private fork of an organization repository.
		 */
		...
		/**
		 * Identifies if the repository is a template that can be used to generate new
		 * repositories.
		 */
		...
		url: Scalars["GitHub_URI"];
		/**
		 * Whether this repository has a custom image to use with Open Graph as
...
export enum GitHub_RepositoryInteractionLimit {
	...
	/**
	 * Users that have not previously committed to a repository’s default branch
...
export enum GitHub_RepositoryPermission {
	...
	Admin = "ADMIN",
	/**
	 * Can read, clone, and push to this repository. They can also manage issues,
	...
	Triage = "TRIAGE",
	/**
	 * Can read, clone, and push to this repository. Can also manage issues and
	 * pull requests
	 */
	Write = "WRITE",
}
 ...
 */
export type GitHub_RepositoryVisibilityChangeDisableAuditEntry =
	GitHub_AuditEntry &
		GitHub_EnterpriseAuditEntryData &
		GitHub_Node &
		GitHub_OrganizationAuditEntryData & {
 ...
 */
export type GitHub_RepositoryVisibilityChangeEnableAuditEntry =
	GitHub_AuditEntry &
		GitHub_EnterpriseAuditEntryData &
		GitHub_Node &
		GitHub_OrganizationAuditEntryData & {
...
/**
 * A Dependabot alert for a repository with a dependency affected by a security
 * vulnerability.
 */
...
/**
 * A hovercard context with a message describing the current code review state
 * of the pull request.
 */
...
export type GitHub_SecurityVulnerability = {
	...
	updatedAt: Scalars["GitHub_DateTime"];
	/**
	 * A string that describes the vulnerable package versions. This string
	 * follows a basic syntax with a few forms.
	 *
...
export type GitHub_SponsorsActivity = GitHub_Node & {
	...
	/**
	 * The user or organization who triggered this activity and was/is sponsoring
	 * the sponsorable.
	 */
	 ...
	 */
	timestamp?: Maybe<Scalars["GitHub_DateTime"]>;
};
...
export enum GitHub_SponsorsActivityAction {
	...
	/**
	 * The activity was changing the sponsorship tier, either directly by the
	 * sponsor or by a scheduled/pending change.
	 */
...
/**
 * A goal associated with a GitHub Sponsors listing, representing a target the
 * sponsored maintainer would like to attain.
 */
...
export type GitHub_SponsorsTier = GitHub_Node & {
	/**
	 * SponsorsTier information only visible to users that can administer the
	 * associated Sponsors listing.
	 */
	adminInfo?: Maybe<GitHub_SponsorsTierAdminInfo>;
	/**
	 * Get a different tier for this tier's maintainer that is at the same
	 * frequency as this tier but with an equal or lesser cost. Returns the
	 * published tier with the monthly price closest to this tier's without going over.
	 */
...
export type GitHub_Sponsorship = GitHub_Node & {
	...
	id: Scalars["ID"];
	/**
	 * Whether this sponsorship represents a one-time payment versus a recurring
	 * sponsorship.
	 */
	isOneTimePayment: Scalars["Boolean"];
	/**
	 * Check if the sponsor has chosen to receive sponsorship update emails sent
	 * from the sponsorable. Only returns a non-null value when the viewer has
	 * permission to know this.
	 */
	isSponsorOptedIntoEmail?: Maybe<Scalars["Boolean"]>;
	/**
	 * The entity that is being sponsored
	 *
	 * @deprecated `Sponsorship.maintainer` will be removed. Use
	 *   `Sponsorship.sponsorable` instead. Removal on 2020-04-01 UTC.
	 */
	...
	/**
	 * The user that is sponsoring. Returns null if the sponsorship is private or
	 * if sponsor is not a user.
	 *
	 * @deprecated `Sponsorship.sponsor` will be removed. Use
	 *   `Sponsorship.sponsorEntity` instead. Removal on 2020-10-01 UTC.
	 */
...
export type GitHub_SponsorshipConnection = {
	...
	/**
	 * The total amount in USD of all recurring sponsorships in the connection
	 * whose amount you can view. Does not include one-time sponsorships.
	 */
...
export type GitHub_StarredRepositoryConnection = {
	...
	/**
	 * Is the list of stars for this user truncated? This is true for users that
	 * have many stars.
	 */
...
/**
 * A suggestion to review a pull request based on a user's commit history and
 * review comments.
 */
 ...
 */
export type GitHub_Tag = GitHub_GitObject &
	GitHub_Node & {
		/**
		 * An abbreviated version of the Git object ID
		 */
 ...
 */
export type GitHub_Team = GitHub_MemberStatusable &
	GitHub_Node &
	GitHub_Subscribable & {
		/**
 ...
 */
export type GitHub_TeamAddMemberAuditEntry = GitHub_AuditEntry &
	GitHub_Node &
	GitHub_OrganizationAuditEntryData &
	GitHub_TeamAuditEntryData & {
		/**
 ...
 */
export type GitHub_TeamAddRepositoryAuditEntry = GitHub_AuditEntry &
	GitHub_Node &
	GitHub_OrganizationAuditEntryData &
	GitHub_RepositoryAuditEntryData &
	GitHub_TeamAuditEntryData & {
 ...
 */
export type GitHub_TeamChangeParentTeamAuditEntry = GitHub_AuditEntry &
	GitHub_Node &
	GitHub_OrganizationAuditEntryData &
	GitHub_TeamAuditEntryData & {
		/**
 ...
 * A team discussion.
 */
export type GitHub_TeamDiscussion = GitHub_Comment &
	GitHub_Deletable &
	GitHub_Node &
	GitHub_Reactable &
	GitHub_Subscribable &
 ...
 */
export type GitHub_TeamDiscussionComment = GitHub_Comment &
	GitHub_Deletable &
	GitHub_Node &
	GitHub_Reactable &
	GitHub_UniformResourceLocatable &
...
export enum GitHub_TeamDiscussionCommentOrderField {
	/**
	 * Allows sequential ordering of team discussion comments (which is equivalent
...
/**
 * Defines which types of team members are included in the returned list. Can be
 * one of IMMEDIATE, CHILD_TEAM or ALL.
 */
 ...
 */
export type GitHub_TeamRemoveMemberAuditEntry = GitHub_AuditEntry &
	GitHub_Node &
	GitHub_OrganizationAuditEntryData &
	GitHub_TeamAuditEntryData & {
		/**
 ...
 */
export type GitHub_TeamRemoveRepositoryAuditEntry = GitHub_AuditEntry &
	GitHub_Node &
	GitHub_OrganizationAuditEntryData &
	GitHub_RepositoryAuditEntryData &
	GitHub_TeamAuditEntryData & {
...
export type GitHub_Topic = GitHub_Node &
	GitHub_Starrable & {
		...
		name: Scalars["String"];
		/**
		 * A list of related topics, including aliases of this topic, sorted with the
		 * most relevant first. Returns up to 10 Topics.
		 */
 ...
 */
export type GitHub_Tree = GitHub_GitObject &
	GitHub_Node & {
		/**
		 * An abbreviated version of the Git object ID
		 */
...
export type GitHub_TreeEntry = {
	...
	repository: GitHub_Repository;
	/**
	 * If the TreeEntry is for a directory occupied by a submodule project, this
	 * returns the corresponding submodule
	 */
...
export type GitHub_UpdateDiscussionInput = {
	...
	body?: Maybe<Scalars["String"]>;
	/**
	 * The Node ID of a discussion category within the same repository to change
	 * this discussion to.
	 */
	categoryId?: Maybe<Scalars["ID"]>;
	/**
...
export type GitHub_UpdateEnterpriseMembersCanChangeRepositoryVisibilitySettingInput =
	{
		...
		clientMutationId?: Maybe<Scalars["String"]>;
		/**
		 * The ID of the enterprise on which to set the members can change repository
		 * visibility setting.
		 */
		enterpriseId: Scalars["ID"];
		/**
...
export type GitHub_UpdateEnterpriseMembersCanCreateRepositoriesSettingInput = {
	...
	/**
	 * When false, allow member organizations to set their own repository creation
	 * member privileges.
	 */
	membersCanCreateRepositoriesPolicyEnabled?: Maybe<Scalars["Boolean"]>;
	/**
	 * Value for the members can create repositories setting on the enterprise.
	 * This or the granular public/private/internal allowed fields (but not both)
	 * must be provided.
	 */
...
export type GitHub_UpdateEnterpriseMembersCanUpdateProtectedBranchesSettingInput =
	{
		...
		clientMutationId?: Maybe<Scalars["String"]>;
		/**
		 * The ID of the enterprise on which to set the members can update protected
		 * branches setting.
		 */
		enterpriseId: Scalars["ID"];
		/**
...
export type GitHub_UpdateEnterpriseMembersCanViewDependencyInsightsSettingInput =
	{
		...
		clientMutationId?: Maybe<Scalars["String"]>;
		/**
		 * The ID of the enterprise on which to set the members can view dependency
		 * insights setting.
		 */
		enterpriseId: Scalars["ID"];
		/**
...
export type GitHub_UpdateEnterpriseMembersCanViewDependencyInsightsSettingPayload =
	{
		...
		enterprise?: Maybe<GitHub_Enterprise>;
		/**
		 * A message confirming the result of updating the members can view dependency
		 * insights setting.
		 */
		message?: Maybe<Scalars["String"]>;
	};
...
export type GitHub_UpdateEnterpriseTwoFactorAuthenticationRequiredSettingInput =
	{
		...
		clientMutationId?: Maybe<Scalars["String"]>;
		/**
		 * The ID of the enterprise on which to set the two factor authentication
		 * required setting.
		 */
		enterpriseId: Scalars["ID"];
		/**
...
export type GitHub_UpdateEnterpriseTwoFactorAuthenticationRequiredSettingPayload =
	{
		...
		enterprise?: Maybe<GitHub_Enterprise>;
		/**
		 * A message confirming the result of updating the two factor authentication
		 * required setting.
		 */
		message?: Maybe<Scalars["String"]>;
	};
...
export type GitHub_UpdateRepositoryInput = {
	...
	clientMutationId?: Maybe<Scalars["String"]>;
	/**
	 * A new description for the repository. Pass an empty string to erase the
	...
	hasWikiEnabled?: Maybe<Scalars["Boolean"]>;
	/**
	 * The URL for a web page about this repository. Pass an empty string to erase
	 * the existing URL.
	 */
	homepageUrl?: Maybe<Scalars["GitHub_URI"]>;
	/**
...
export type GitHub_UpdateTeamDiscussionInput = {
	 ...
	 * will be rejected if the given version does not match the latest version on
	 * the server.
	 */
	bodyVersion?: Maybe<Scalars["String"]>;
	/**
...
/**
 * A user is an individual's account on GitHub that owns repositories and can
 * make new content.
 */
export type GitHub_User = GitHub_Actor &
	GitHub_Node &
	GitHub_PackageOwner &
	GitHub_ProfileOwner &
	GitHub_ProjectOwner &
	...
	GitHub_UniformResourceLocatable & {
		...
		/**
		 * Could this user receive email notifications, if the organization had
		 * notification restrictions enabled?
		 */
		...
		organization?: Maybe<GitHub_Organization>;
		/**
		 * Verified email addresses that match verified domains for a specified
		...
		status?: Maybe<GitHub_UserStatus>;
		/**
		 * Repositories the user has contributed to, ordered by contribution rank,
		 * plus repositories the user has created
		 */
...
export type GitHub_UserStatus = GitHub_Node & {
	...
	message?: Maybe<Scalars["String"]>;
	/**
	 * The organization whose members can see this status. If null, this status is
	 * publicly visible.
	 */
	organization?: Maybe<GitHub_Organization>;
	/**
...
export type GitHub_VerifiableDomain = GitHub_Node & {
	...
	/**
	 * Whether this domain is required to exist for an organization or enterprise
...
export type SitePageContext = {
	id?: Maybe<Scalars["String"]>;
	ogImage?: Maybe<SitePageContextOgImage>;
	repositoryName?: Maybe<Scalars["String"]>;
...
export type SitePageContextFilterInput = {
	id?: Maybe<StringQueryOperatorInput>;
	ogImage?: Maybe<SitePageContextOgImageFilterInput>;
	repositoryName?: Maybe<StringQueryOperatorInput>;
	repositoryOwner?: Maybe<StringQueryOperatorInput>;
};

export type SitePageContextOgImage = {
	_xogImageGenerationContext?: Maybe<SitePageContextOgImage_XogImageGenerationContext>;
	path?: Maybe<Scalars["String"]>;
	size?: Maybe<SitePageContextOgImageSize>;
};

export type SitePageContextOgImageFilterInput = {
	_xogImageGenerationContext?: Maybe<SitePageContextOgImage_XogImageGenerationContextFilterInput>;
	path?: Maybe<StringQueryOperatorInput>;
	size?: Maybe<SitePageContextOgImageSizeFilterInput>;
};

export type SitePageContextOgImageSize = {
	height?: Maybe<Scalars["Int"]>;
	width?: Maybe<Scalars["Int"]>;
};

export type SitePageContextOgImageSizeFilterInput = {
	height?: Maybe<IntQueryOperatorInput>;
	width?: Maybe<IntQueryOperatorInput>;
};

export type SitePageContextOgImage_XogImageGenerationContext = {
	componentPath?: Maybe<Scalars["String"]>;
	imgPath?: Maybe<Scalars["String"]>;
	size?: Maybe<SitePageContextOgImage_XogImageGenerationContextSize>;
};

export type SitePageContextOgImage_XogImageGenerationContextFilterInput = {
	componentPath?: Maybe<StringQueryOperatorInput>;
	imgPath?: Maybe<StringQueryOperatorInput>;
	size?: Maybe<SitePageContextOgImage_XogImageGenerationContextSizeFilterInput>;
};

export type SitePageContextOgImage_XogImageGenerationContextSize = {
	height?: Maybe<Scalars["Int"]>;
	width?: Maybe<Scalars["Int"]>;
};

export type SitePageContextOgImage_XogImageGenerationContextSizeFilterInput = {
	height?: Maybe<IntQueryOperatorInput>;
	width?: Maybe<IntQueryOperatorInput>;
};
...
export enum SitePageFieldsEnum {
	...
	ContextOgImageXogImageGenerationContextComponentPath = "context___ogImage____xogImageGenerationContext___componentPath",
	ContextOgImageXogImageGenerationContextImgPath = "context___ogImage____xogImageGenerationContext___imgPath",
	ContextOgImagePath = "context___ogImage___path",
	ContextOgImageSizeHeight = "context___ogImage___size___height",
	ContextOgImageSizeWidth = "context___ogImage___size___width",
	ContextRepositoryName = "context___repositoryName",
	ContextRepositoryOwner = "context___repositoryOwner",
	Id = "id",
...
export type DevtoArticleOpenGraphImageQuery = {
	file?: Maybe<{
		childMarkdownRemark?: Maybe<{
			frontmatter?: Maybe<{
				title?: Maybe<string>;
				author?: Maybe<string>;
				author_avatar?: Maybe<string>;
				date?: Maybe<string>;
			}>;
		}>;
	}>;
...
export type DevtoArticleQueryVariables = Exact<{
	id: Scalars["String"];
}>;

export type DevtoArticleQuery = {
	file?: Maybe<{
		name: string;
		childMarkdownRemark?: Maybe<{
...
export type GatsbyArticleOpenGraphImageQueryVariables = Exact<{
	id: Scalars["String"];
}>;

export type GatsbyArticleOpenGraphImageQuery = {
	file?: Maybe<{
		childMarkdownRemark?: Maybe<{
			frontmatter?: Maybe<{
				title?: Maybe<string>;
...
export type GatsbyArticleQueryVariables = Exact<{
	id: Scalars["String"];
}>;

export type GatsbyArticleQuery = {
	file?: Maybe<{
		name: string;
		childMarkdownRemark?: Maybe<{
			frontmatter?: Maybe<{ title?: Maybe<string> }>;
...
export type GitHubRepositoryOpenGraphImageQueryVariables = Exact<{
	repositoryOwner: Scalars["String"];
	repositoryName: Scalars["String"];
}>;

export type GitHubRepositoryOpenGraphImageQuery = {
	github: {
		repository?: Maybe<{
			name: string;
			...
			languages?: Maybe<{
				totalSize: number;
				edges?: Maybe<
					Array<Maybe<{ size: number; node: { color?: Maybe<string> } }>>
				>;
			}>;
		}>;
	};
...
export type GitHubRepositoryTemplateQueryVariables = Exact<{
	repositoryOwner: Scalars["String"];
	repositoryName: Scalars["String"];
}>;

export type GitHubRepositoryTemplateQuery = {
	github: {
		repository?: Maybe<{
			name: string;
